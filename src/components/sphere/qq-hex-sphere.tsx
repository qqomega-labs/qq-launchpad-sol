  ...
  return (
    ...
    >
      <div className="flex-1 min-w-0">
        ...
        <p className="text-xs text-text-muted m-0 leading-snug font-sans">
          {data.note}
        </p>
      </div>
      <button
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            height: sphereR * 2.4,
            background:
              "radial-gradient(circle, rgba(253,1,90,.12) 0%, rgba(253,1,90,.02) 50%, transparent 70%)",
          }}
        />
            ...
            return (
              <g
                ...
                onClick={() => {
                  if (!dragRef.current.moved)
                    setSelected(selected === p.idx ? null : p.idx);
                }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.opacity = "1";
                  e.currentTarget
                    .querySelector(".hexFill")
                    ?.setAttribute("filter", "url(#hexGlow)");
                }}
                onMouseLeave={(e) => {
              ...
              >
                <path
                  ...
                  fill={
                    isSel
                      ? `hsla(${h},${s + 10}%,${fillL + 8}%,${Math.min(1, fillA + 0.2)})`
                      : fill
                  }
                ...
                {vis && (
                  <text
                    ...
                    style={{
                      textShadow:
                        "0 1px 3px rgba(0,0,0,.7), 0 0 6px rgba(0,0,0,.4)",
                    }}
